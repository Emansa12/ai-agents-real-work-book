...
The system will research, draft, review, and publish a technical article or short book on how AI agents are replacing real human work and what that means for the future of automation.
...
- At least one **TikZ** architecture or workflow diagram (e.g., the agent pipeline or system architecture).
...
- The system must not support a fallback that skips live research or uses hardcoded article content in production runs.
